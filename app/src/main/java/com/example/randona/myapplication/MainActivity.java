...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Inicializando el expandable list view object
        ...
        //Poner values en los headings con un for each loop
        ...
        //Representando el ctx, list y arraylist
        MyAdapter myAdapter = new MyAdapter(this, Headings,ChildList);
        //Ahora poner el adapter en el listview
